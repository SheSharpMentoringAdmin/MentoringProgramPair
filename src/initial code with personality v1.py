...
df_new['mean_cosine_similarity'] = df_new['mean_cosine_similarity'].astype(float)  # Convert to float and add to new DataFrame
...
NUM_PREFERENCE_FEATURES = padded_df.shape[1]
